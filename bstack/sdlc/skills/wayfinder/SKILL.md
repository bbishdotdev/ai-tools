...
Default to one substantial non-research question per session. A broader authorized run may continue through fresh [handoffs](../../../shared/skills/handoff/SKILL.md), carrying authority and current IDs rather than the full conversation. Host support determines whether those sessions can launch automatically. Do not claim an unattended loop without a working runner.

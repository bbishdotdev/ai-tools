...
- Workers never rebase and never run `gt`. Babysitters follow `babysit.md`, one per stack, scoped to one immutable frontier generation. They report conflicts to the stacker rather than restacking.

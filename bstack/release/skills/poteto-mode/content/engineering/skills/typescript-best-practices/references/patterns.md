...
Code examples for each rule in `../WORKFLOW.md`. The underlying principles are language-agnostic. See the **type-system-discipline** and **boundary-discipline** principle skills.
